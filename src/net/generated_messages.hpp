...
void append(MessageBuilder *msg, ListGamesResponse &in) { append(msg, in.games); }
...
void append(MessageBuilder *msg, GetGameRequest &in) { append(msg, in.game_id); }
...
void append(MessageBuilder *msg, StartGameRequest &in) { append(msg, in.game_id); }
...
void append(MessageBuilder *msg, PlayerLeftMessage &in) { append(msg, in.user_id); }
...
void append(MessageBuilder *msg, InGameAnswerMessage &in) { append(msg, in.answer); }
...
void append(MessageBuilder *msg, InGameChoosePassOrPlayMessage &in) { append(msg, in.play); }
...
void append(MessageBuilder *msg, InGameStartRoundMessage &in) { append(msg, in.round); }
...
void append(MessageBuilder *msg, InGamePromptForAnswerMessage &in) { append(msg, in.user_id); }
...
void append(MessageBuilder *msg, InGameStartPlayMessage &in) { append(msg, in.family); }
...
void append(MessageBuilder *msg, InGameStartStealMessage &in) { append(msg, in.family); }
...
void append(MessageBuilder *msg, InGameEggghhhhMessage &in) { append(msg, in.n_incorrects); }
...
void append(MessageBuilder *msg, InGameEndGameMessage &in) { append(msg, in.game_winner); }
