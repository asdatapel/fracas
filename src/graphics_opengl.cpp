...
static void draw_threed(RenderTarget target, Camera camera, glm::mat4 model, VertexBuffer buf, Material material, Texture cubemap, Texture env_map, Texture brdf_lut)
{
    ...
    unsigned int cam_pos_uniform = glGetUniformLocation(threed_shader, "cam_pos");
    unsigned int albedo_tex_uniform = glGetUniformLocation(threed_shader, "albedo_tex");
    unsigned int normal_tex_uniform = glGetUniformLocation(threed_shader, "normal_tex");
    unsigned int metal_tex_uniform = glGetUniformLocation(threed_shader, "metal_tex");
    unsigned int roughness_tex_uniform = glGetUniformLocation(threed_shader, "roughness_tex");
    unsigned int irradiance_uniform = glGetUniformLocation(threed_shader, "irradiance");
    unsigned int env_uniform = glGetUniformLocation(threed_shader, "env");
    ...
    glUniform3f(cam_pos_uniform, camera.pos_x, camera.pos_y, camera.pos_z);
...
static void draw_bar(RenderTarget target, Camera camera, glm::mat4 model, VertexBuffer buf, Material material, Texture cubemap, Texture env_map, Texture brdf_lut, Texture text)
{
    ...
    unsigned int cam_pos_uniform = glGetUniformLocation(bar_shader, "cam_pos");
    unsigned int albedo_tex_uniform = glGetUniformLocation(bar_shader, "albedo_tex");
    unsigned int normal_tex_uniform = glGetUniformLocation(bar_shader, "normal_tex");
    unsigned int metal_tex_uniform = glGetUniformLocation(bar_shader, "metal_tex");
    unsigned int roughness_tex_uniform = glGetUniformLocation(bar_shader, "roughness_tex");
    unsigned int irradiance_uniform = glGetUniformLocation(bar_shader, "irradiance");
    unsigned int env_uniform = glGetUniformLocation(bar_shader, "env");
    unsigned int brdf_uniform = glGetUniformLocation(bar_shader, "brdf");
    unsigned int text_tex_uniform = glGetUniformLocation(bar_shader, "text_tex");
...
{
    int textured_mapped_shader_resolution_uniform = glGetUniformLocation(textured_mapped_shader, "resolution");
    int textured_mapped_shader_pos_uniform = glGetUniformLocation(textured_mapped_shader, "pos");
    int textured_mapped_shader_scale_uniform = glGetUniformLocation(textured_mapped_shader, "scale");
    int textured_mapped_shader_uv_uniform = glGetUniformLocation(textured_mapped_shader, "uv");
